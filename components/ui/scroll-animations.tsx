 ...
 * Drop this component on a page, then tag elements with:
...
export function ScrollAnimations() {
  useEffect(() => {
    ...
    // SplitText + ScrollSmoother lag: each character loosens its connection
    // to the scroll a little more than the last (the demo's "stagger..." bit).
    // Runs a frame later so the smoother (created in a parent effect) exists.
